...
class ServiceBusAdministrationClient extends coreClient.ServiceClient {
    ...
    listQueuesAll(options = {}) {
        return tslib.__asyncGenerator(this, arguments, function* listQueuesAll_1() {
            ...
            let marker;
            try {
                for (var _d = true, _e = tslib.__asyncValues(this.listQueuesPage(marker, options)), _f; _f = yield tslib.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const segment = _c;
    ...
    listQueuesRuntimePropertiesAll(options = {}) {
        return tslib.__asyncGenerator(this, arguments, function* listQueuesRuntimePropertiesAll_1() {
            ...
            let marker;
            try {
                for (var _d = true, _e = tslib.__asyncValues(this.listQueuesRuntimePropertiesPage(marker, options)), _f; _f = yield tslib.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const segment = _c;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(segment)));
    ...
    listTopicsAll(options = {}) {
        return tslib.__asyncGenerator(this, arguments, function* listTopicsAll_1() {
            ...
            let marker;
            try {
                for (var _d = true, _e = tslib.__asyncValues(this.listTopicsPage(marker, options)), _f; _f = yield tslib.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const segment = _c;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(segment)));
    ...
    listTopicsRuntimePropertiesAll(options = {}) {
        return tslib.__asyncGenerator(this, arguments, function* listTopicsRuntimePropertiesAll_1() {
            ...
            let marker;
            try {
                for (var _d = true, _e = tslib.__asyncValues(this.listTopicsRuntimePropertiesPage(marker, options)), _f; _f = yield tslib.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const segment = _c;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(segment)));
    ...
    listSubscriptionsAll(topicName, options = {}) {
        return tslib.__asyncGenerator(this, arguments, function* listSubscriptionsAll_1() {
            ...
            let marker;
            try {
                for (var _d = true, _e = tslib.__asyncValues(this.listSubscriptionsPage(topicName, marker, options)), _f; _f = yield tslib.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const segment = _c;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(segment)));
    ...
    listSubscriptionsRuntimePropertiesAll(topicName, options = {}) {
        return tslib.__asyncGenerator(this, arguments, function* listSubscriptionsRuntimePropertiesAll_1() {
            ...
            let marker;
            try {
                for (var _d = true, _e = tslib.__asyncValues(this.listSubscriptionsRuntimePropertiesPage(topicName, marker, options)), _f; _f = yield tslib.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const segment = _c;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(segment)));
    ...
    listRulesAll(topicName, subscriptionName, options = {}) {
        return tslib.__asyncGenerator(this, arguments, function* listRulesAll_1() {
            ...
            let marker;
            try {
                for (var _d = true, _e = tslib.__asyncValues(this.listRulesPage(topicName, subscriptionName, marker, options)), _f; _f = yield tslib.__await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const segment = _c;
                    yield tslib.__await(yield* tslib.__asyncDelegator(tslib.__asyncValues(segment)));
...
class ManagementClient extends LinkEntity {
    ...
    async _makeManagementRequest(request, internalLogger, sendRequestOptions = {}) {
        ...
        try {
            ...
            await waitForSendable(internalLogger, this.logPrefix, this.name, timeoutInMs !== null && timeoutInMs !== void 0 ? timeoutInMs : coreAmqp.Constants.defaultOperationTimeoutInMs, (_a = this.link) === null || _a === void 0 ? void 0 : _a.sender, (_d = (_c = (_b = this.link) === null || _b === void 0 ? void 0 : _b.session) === null || _c === void 0 ? void 0 : _c.outgoing) === null || _d === void 0 ? void 0 : _d.available());
...
class MessageSender extends LinkEntity {
    ...
    _trySend(encodedMessage, sendBatch, options) {
        ...
        const sendEventPromise = async () => {
            ...
            const waitingTime = await waitForSendable(senderLogger, this.logPrefix, this.name, timeoutInMs - timeTakenByInit, this.link, (_g = (_f = (_e = this.link) === null || _e === void 0 ? void 0 : _e.session) === null || _f === void 0 ? void 0 : _f.outgoing) === null || _g === void 0 ? void 0 : _g.available());
...
class MessageSession extends LinkEntity {
    ...
    async createRheaLink(options, _abortSignal) {
        ...
        const receivedSessionId = (_b = (_a = link.source) === null || _a === void 0 ? void 0 : _a.filter) === null || _b === void 0 ? void 0 : _b[coreAmqp.Constants.sessionFilterName];
    ...
    async _init(opts = {}) {
        ...
        try {
            ...
            const receivedSessionId = (_b = (_a = this.link.source) === null || _a === void 0 ? void 0 : _a.filter) === null || _b === void 0 ? void 0 : _b[coreAmqp.Constants.sessionFilterName];
